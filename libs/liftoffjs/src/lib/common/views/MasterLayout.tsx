  ...
  return (
    <>
      <head>
        ...
        {reactClientAssets.linkTags.map(url => (
          <link key={url} rel="stylesheet" href={'/client/' + url} />
        ))}
      </head>
      <body className="dark:bg-gray-900">
        ...
        {!props.contain ? props.children : <div className="container mx-auto">{props.children}</div>}
