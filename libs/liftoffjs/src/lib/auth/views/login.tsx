  ...
  <MasterLayout contain={true}>
    <lo-login-form set-cookie="true" redirect-to="/">
      <div className="rounded-xl bg-gradient-to-r bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-2 sm:p-6 dark:bg-gray-800">
        ...
        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
        <a href="/auth/forgot-password" className="block text-white my-2.5">Forgot password?</a>
      </div>
    </lo-login-form>
  </MasterLayout>
);